...
# List all .cc files in the current directory
source_files = glob.glob('*.cc')


# Define the extension module
factory_module = Extension(
    'PyFactory',                            # Module name in Python
    
    sources=['factory_bindings.cpp', 'system.cc', 'system_evolution.cc', 'planets_factory.cc',
